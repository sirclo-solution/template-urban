const locale = {
    "disclaimer": {
        "contact": "Dengan menekan tombol 'Kirim', saya mengetahui dan menyetujui {PRIVACY_POLICY} serta mengizinkan {BRAND_NAME} untuk menanggapi pesan saya menggunakan detail kontak yang telah saya berikan.",
        "loginByEmail": "Dengan menekan tombol 'Masuk', saya mengetahui dan menyetujui {TERMS_AND_CONDITIONS} serta {PRIVACY_POLICY} dari {BRAND_NAME}.",
